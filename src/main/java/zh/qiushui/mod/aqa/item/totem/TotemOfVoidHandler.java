package zh.qiushui.mod.aqa.item.totem;
...
public class TotemOfVoidHandler implements TotemHandler {
    ...
    public boolean execute(DamageSource source, LivingEntity entity, ItemStack totem) {
        if (entity instanceof ServerPlayer player) {
            player.awardStat(Stats.ITEM_USED.get(AqaItems.TOTEM_OF_VOID.asItem()), 1);
            CriteriaTriggers.USED_TOTEM.trigger(player, AqaItems.TOTEM_OF_VOID.asStack());
